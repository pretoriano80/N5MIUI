...
static struct acpu_level acpu_freq_tbl_2p3g_pvs0[] __initdata = {
	...
	{ 0, {  499200, HFPLL, 2,  52 },  L2(3),  805000, 120 },
	{ 0, {  576000, HFPLL, 1,  30 },  L2(4),  815000, 139 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(5),  825000, 159 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(6),  835000, 180 },
	{ 0, {  806400, HFPLL, 1,  42 },  L2(7),  845000, 200 },
	...
	{ 0, { 1651200, HFPLL, 1,  86 }, L2(18),  980000, 456 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(19),  995000, 482 },
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(19), 1010000, 510 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(19), 1025000, 538 },
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs1[] __initdata = {
	...
	{ 0, {  345600, HFPLL, 2,  36 },  L2(1),  800000,  83 },
	{ 1, {  422400, HFPLL, 2,  44 },  L2(2),  800000, 101 },
	{ 0, {  499200, HFPLL, 2,  52 },  L2(3),  800000, 120 },
	{ 0, {  576000, HFPLL, 1,  30 },  L2(4),  800000, 139 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(5),  810000, 159 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(6),  820000, 180 },
	{ 0, {  806400, HFPLL, 1,  42 },  L2(7),  830000, 200 },
	...
	{ 0, { 1651200, HFPLL, 1,  86 }, L2(18),  960000, 456 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(19),  975000, 482 },
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(19),  990000, 510 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(19), 1005000, 538 },
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs2[] __initdata = {
	...
	{ 0, {  499200, HFPLL, 2,  52 },  L2(3),  775000, 120 },
	{ 0, {  576000, HFPLL, 1,  30 },  L2(4),  785000, 139 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(5),  795000, 159 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(6),  805000, 180 },
	{ 0, {  806400, HFPLL, 1,  42 },  L2(7),  815000, 200 },
	...
	{ 0, { 1651200, HFPLL, 1,  86 }, L2(18),  940000, 456 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(19),  955000, 482 },
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(19),  970000, 510 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(19),  980000, 538 },
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs3[] __initdata = {
	...
	{ 1, {  422400, HFPLL, 2,  44 },  L2(2),  775000, 101 },
	{ 0, {  499200, HFPLL, 2,  52 },  L2(3),  775000, 120 },
	{ 0, {  576000, HFPLL, 1,  30 },  L2(4),  775000, 139 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(5),  780000, 159 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(6),  790000, 180 },
	{ 0, {  806400, HFPLL, 1,  42 },  L2(7),  800000, 200 },
	...
	{ 0, { 1651200, HFPLL, 1,  86 }, L2(18),  925000, 456 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(19),  935000, 482 },
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(19),  950000, 510 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(19),  960000, 538 },
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs4[] __initdata = {
	...
	{ 0, {  806400, HFPLL, 1,  42 },  L2(7),  790000, 200 },
	...
	{ 0, { 1651200, HFPLL, 1,  86 }, L2(18),  910000, 456 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(19),  920000, 482 },
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(19),  930000, 510 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(19),  940000, 538 },
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs5[] __initdata = {
	...
	{ 0, {  499200, HFPLL, 2,  52 },  L2(3),  750000, 120 },
	{ 0, {  576000, HFPLL, 1,  30 },  L2(4),  750000, 139 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(5),  760000, 159 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(6),  770000, 180 },
	{ 0, {  806400, HFPLL, 1,  42 },  L2(7),  780000, 200 },
	...
	{ 0, { 1651200, HFPLL, 1,  86 }, L2(18),  890000, 456 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(19),  900000, 482 },
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(19),  910000, 510 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(19),  920000, 538 },
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs6[] __initdata = {
	...
	{ 0, {  806400, HFPLL, 1,  42 },  L2(7),  770000, 200 },
	...
	{ 0, { 1651200, HFPLL, 1,  86 }, L2(18),  875000, 456 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(19),  885000, 482 },
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(19),  895000, 510 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(19),  905000, 538 },
