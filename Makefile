...
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer \
	       -fgcse-las -Wno-unused-parameter -Wno-sign-compare \
	       -Wno-missing-field-initializers -Wno-unused-variable -Wno-unused-value
...
KERNELFLAGS	= -O2 -DNDEBUG -munaligned-access -fgcse-lm -fgcse-sm \
		  -fsched-spec-load -fforce-addr -ffast-math -fsingle-precision-constant \
		  -mcpu=cortex-a15 -mtune=cortex-a15 -marm -mfpu=neon-vfpv4 -ftree-vectorize \
		  -mvectorize-with-neon-quad -funroll-loops -fgraphite-identity \
